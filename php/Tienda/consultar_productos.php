...
<body>
    ...
    <div class="container d-flex justify-content-center aling-items-center">
        <form action="" method="POST">
            ...
            <input type="submit" class="btn btn-danger mt-1" value="buscar">
    ...
    <div class="container">
        ...
        <a href="cerrar.php"><button>Salir</button></a>
            <form action="" method="POST">
                <div class="row-fluid">
                    <div class="span4">
                ...
                <button type="submit" class="btn btn-danger mt-1"><i class="icon-search"></i>Buscar</button>
            </form>
            <thead>
                <tr>
                    <th scope="col">Id</th>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a  href="modificar.php?
                                ...
                                cantidad=<?php echo $cantidad ?>" title="Editar">
                                <i class="btn btn-danger">Editar</i>
                        </a>
